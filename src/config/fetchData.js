...
export const regis = `api/regist`;
export const regisOTP = `api/sendOTP/regist`;
export const forgotEmail = `api/sendOTP/forget`;
export const putOTPChangePassword = `api/changePassword`;
