         ...
         <div class="row g-4">
                  ...
                  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSideNavbar">
                     ...
                     <div class="offcanvas-body d-block px-2 px-lg-0">
                           ...
                           <div class="card-body pt-0">
                              <div class="text-center">
                                 <div class="avatar avatar-lg mt-n5 mb-3">
                                    <a href="#!">
                                       <img class="avatar-img rounded border border-white border-3" src={''} />
                                    </a>
                                 </div>
                                 <h5 class="mb-0">
                                    {' '}
                              ...
                              <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                                 <li class="nav-item">
                                    <a class="nav-link" href="my-profile.html">
                                       {' '}
                                       <img class="me-2 h-20px fa-fw" src={''} alt="" />
                                       <span>Feed </span>
                                    </a>
                                 </li>
                                 <li class="nav-item">
                        ...
                        <ul class="nav small mt-4 justify-content-center lh-1">
                           ...
                           <li class="nav-item">
                              <a class="nav-link" target="_blank" href="https://support.webestica.com/login">
                                 Support{' '}
                              </a>
                           </li>
                           <li class="nav-item">
                        ...
                        <p class="small text-center mt-1">
                           ©2023{' '}
                           <a class="text-body" target="_blank" href="https://www.webestica.com/">
                              {' '}
                              Webestica{' '}
                           </a>
                        </p>
            ...
            <div class="col-md-8 col-lg-6 vstack gap-4">
               <div class="d-flex gap-2 mb-n3">
                  ...
                  >
                     <div
                        class="story "
                        data-id="user-1"
                        data-photo="assets/images/post/1by1/02.jpg"
                        data-last-updated="1696410190.658"
                     >
                     ...
                     <div
                        class="story "
                        data-id="user-3"
                        data-photo="assets/images/post/1by1/04.jpg"
                        data-last-updated="1696410190.658"
                     >
                        <a class="item-link" href="">
                           <span class="item-preview">
                     ...
                     <div class="story " data-id="user-7" data-photo="assets/images/albums/05.jpg" data-last-updated="">
                        <a class="item-link" href="">
                           <span class="item-preview">
               ...
               <div class="card card-body">
                  ...
                  <ul class="nav nav-pills nav-stack small fw-normal">
                     ...
                     <li class="nav-item">
                        ...
                        >
                           {' '}
                           <i class="bi bi-emoji-smile-fill text-warning pe-2"></i>Feeling /Activity
                        </a>
                     </li>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <p>
                        I'm so privileged to be involved in the <a href="#!">@bootstrap </a>hiring process! Interviewing
                        with their team was fun and I hope this can be a valuable resource for folks!{' '}
                        <a href="#!"> #inclusivebusiness</a> <a href="#!"> #internship</a> <a href="#!"> #hiring</a>{' '}
                        <a href="#"> #apply </a>
                     </p>
                     <div class="d-flex justify-content-between">
                        <div class="row g-3">
                     ...
                     <ul class="nav nav-stack py-3 small">
                        <li class="nav-item">
                           <a class="nav-link active text-secondary" href="#!">
                              {' '}
                              <i class="bi bi-heart-fill me-1 icon-xs bg-danger text-white rounded-circle"></i> Louis,
                              Billy and 126 others{' '}
                           </a>
                        </li>
               ...
               <div class="card">
                  ...
                  <div class="card-body pb-0">
                     <p>
                        Find out how you can save time in the classroom this year. Earn recognition while you learn new
                        skills on iPad and Mac. Start recognition your first Apple Teacher badge today!
                     </p>
                     ...
                     <div class="tiny-slider arrow-hover">
                        <div class="tns-outer" id="tns1-ow">
                           <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">
                              slide <span class="current">11 to 15</span> of 4
                           </div>
                           <div id="tns1-mw" class="tns-ovh">
                              <div class="tns-inner" id="tns1-iw">
                                 <div
                                    ...
                                    data-edge="30"
                                    id="tns1"
                                    // style="transform: translate3d(-61.1111%, 0px, 0px);"
                                 >
               ...
               <div class="card">
                     ...
                     <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                           <div class="avatar me-2">
                              <a href="#!">
                                 {' '}
                                 <img class="avatar-img rounded-circle" src="assets/images/logo/11.svg" alt="" />{' '}
                              </a>
                           </div>
                           <div>
                              <h6 class="card-title mb-0">
                  ...
                  <div class="card-body">
                     <p class="mb-0">
                        The next-generation blog, news, and magazine theme for you to start sharing your content today
                        with beautiful aesthetics! This minimal &amp; clean Bootstrap 5 based theme is ideal for all
                        types of sites that aim to provide users with content. <a href="#!"> #bootstrap</a>{' '}
                        <a href="#!"> #webestica </a> <a href="#!"> #getbootstrap</a> <a href="#"> #bootstrap5 </a>
                     </p>
                  </div>
                  <a href="#!">
                     {' '}
               ...
               <div class="card">
                  ...
                  <div class="card-body pb-0">
                     <p>
                        Comfort reached gay perhaps chamber his <a href="#!">#internship</a> <a href="#!">#hiring</a>{' '}
                        <a href="#!">#apply</a>{' '}
                     </p>
                  </div>
                        ...
                        >
                           <div class="plyr__controls">
                              <button
                                 ...
                                 aria-label="Play"
                              >
                                 <svg class="icon--pressed" aria-hidden="true" focusable="false"></svg>
                                 <svg class="icon--not-pressed" aria-hidden="true" focusable="false"></svg>
                              ...
                              <div class="plyr__controls__item plyr__menu">
                                 <button
                                    aria-haspopup="true"
                                    aria-controls="plyr-settings-5619"
                                    aria-expanded="false"
                                    type="button"
                                    class="plyr__control"
                                    data-plyr="settings"
                                 ...
                                 <div class="plyr__menu__container" id="plyr-settings-5619" hidden="">
                                    <div>
                                       <div id="plyr-settings-5619-home">
                                          <div role="menu">
                                             <button
                                                data-plyr="settings"
                                                type="button"
                                             ...
                                             >
                                                <span>
                                                   Captions
                                                   <span class="plyr__menu__value">Disabled</span>
                                                </span>
                                             </button>
                                             <button
                                                data-plyr="settings"
                                             ...
                                             >
                                                <span>
                                                   Speed
                                                   <span class="plyr__menu__value">Normal</span>
                                                </span>
                                             </button>
                                          </div>
                                       </div>
                                       <div id="plyr-settings-5619-captions" hidden="">
                                       ...
                                       <div id="plyr-settings-5619-quality" hidden="">
                                          <button type="button" class="plyr__control plyr__control--back">
                                       ...
                                       <div id="plyr-settings-5619-speed" hidden="">
                                          <button type="button" class="plyr__control plyr__control--back">
                  ...
                  <div class="col-sm-6 col-lg-12">
                     <div class="card">
                        ...
                        <div class="card-body">
                           <div class="mb-3">
                              <h6 class="mb-0">
                                 <a href="blog-details.html">Ten questions you should answer truthfully</a>
                              </h6>
                              <small>2hr</small>
                           </div>
                           <div class="mb-3">
                           ...
                           <div class="mb-3">
                              <h6 class="mb-0">
                                 <a href="blog-details.html">Best Pinterest Boards for learning about business</a>
                              </h6>
                              <small>4hr</small>
                           </div>
                           <div class="mb-3">
                              <h6 class="mb-0">
                                 <a href="blog-details.html">Skills that you can learn from business</a>
                              </h6>
                              <small>6hr</small>
                           </div>
                           <a
